...
public class Weka_Tools {
    ...
    public boolean weka3D = true;
    public String modelVessel = "";
    public String modelMicro = "";
    ...
    **/
    ...
    public void preprocessFile(String imageDir, String processDir, ArrayList<String> imageFiles, String[] chsName, String[] channels) throws Exception {
     ...
     public Objects3DIntPopulation goWeka(ImagePlus img, String model){
        // Do Weka
        Objects3DIntPopulation  pop = new Objects3DIntPopulation();
        // Segment channel with Weka
    ...
    public ImagePlus[] compute_param(Objects3DIntPopulation vesselsPop, Objects3DIntPopulation microPop, Roi roi,
        ...
        double vesselsVol = new MeasureVolume(vesselRoiObj).getVolumeUnit();
        // Compute distance map
        ImageHandler imhMap = ImageHandler.wrap(imgVessels).createSameDimensions();
        vesselRoiObj.drawObject(imhMap, 255);
        ...
        imgs = createImageObjects(vesselRoiObj, microRoiPop, imgs, imgVessels);
        return(imgs);
    }      
}
